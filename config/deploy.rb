...
namespace :deploy do
  task :start_dispatcher do
    run "cd #{deploy_to}/current && ruby dispatcher_controller.rb start"
  end

  task :start_workers do
    run "cd #{deploy_to}/current && ruby worker_controller.rb start"
  end

  task :start_server do
    run "cd #{deploy_to}/current && ruby skeeter_controller.rb start"
  end

  task :stop_dispatcher do
    run "cd #{deploy_to}/current && ruby dispatcher_controller.rb stop"
  end

  task :stop_workers do
    run "cd #{deploy_to}/current && ruby worker_controller.rb stop"
  end

  task :stop_server do
    run "cd #{deploy_to}/current && ruby skeeter_controller.rb stop"
  end
